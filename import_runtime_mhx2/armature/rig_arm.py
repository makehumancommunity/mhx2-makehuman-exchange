...
HeadsTails = {
    ...
    "clav-1.L" :         ("l-clav-1", "l-clav-2"),
    "clav-2.L" :         ("l-clav-2", "l-clav-3"),
    "clav-3.L" :         ("l-clav-3", "l-clav-4"),

    "clavicle.R" :          ("r-clavicle", "r-clav-4"),
    "clav-1.R" :         ("r-clav-1", "r-clav-2"),
    "clav-2.R" :         ("r-clav-2", "r-clav-3"),
    "clav-3.R" :         ("r-clav-3", "r-clav-4"),
...
Armature = {
    ...
    "clav-2.L" :        (0, "clav-1.L", F_DEF|F_CON, L_DEF),
    "clav-3.L" :        (0, "clav-2.L", F_DEF|F_CON, L_DEF),

    "clavicle.R" :          (0, "chest-1", F_DEF, L_RARMFK|L_RARMIK),
    "clav-1.R" :        (0, "clavicle.R", F_DEF, L_DEF),
    "clav-2.R" :        (0, "clav-1.R", F_DEF|F_CON, L_DEF),
    "clav-3.R" :        (0, "clav-2.R", F_DEF|F_CON, L_DEF),

    "scapAim.L" :           (0, "clav-3.L", 0, L_HELP),
    "scapula.L" :       (0, "scapAim.L", F_DEF, L_DEF),

    "scapAim.R" :           (0, "clav-3.R", 0, L_HELP),
    "scapula.R" :       (0, "scapAim.R", F_DEF, L_DEF),

    #"loc_shoulder.L" :      (0, "clav-3.L", 0, L_HELP),
    #"deltoidBend.L" :       (0, "clav-3.L", 0, L_HELP),
    "deltoid.L" :       (0, "clav-3.L", F_DEF, L_DEF),

    #"loc_shoulder.R" :      (0, "clav-3.R", 0, L_HELP),
    #"deltoidBend.R" :       (0, "clav-3.R", 0, L_HELP),
    "deltoid.R" :       (0, "clav-3.R", F_DEF, L_DEF),

    "pectIk.L" :            (0, "clav-1.L", 0, L_HELP),
    "pectIk.R" :            (0, "clav-1.R", 0, L_HELP),

    "upper_arm.L" :         ("PlaneArm.L", "clav-3.L", F_DEF, L_LARMFK),
    ...
    "upper_arm.R" :         ("PlaneArm.R", "clav-3.R", F_DEF, L_LARMFK),
...
Constraints = {
    ...
    "clav-1.L" : [("CopyRot", C_LOCAL, 1, ["clavicle.L", "clavicle.L", (1,1,1), (0,0,0), False])],
    "clav-2.L" : [("CopyRot", C_LOCAL, 1, ["clavicle.L", "clavicle.L", (1,1,1), (0,0,0), False])],
    "clav-3.L" : [("CopyRot", C_LOCAL, 1, ["clavicle.L", "clavicle.L", (1,1,1), (0,0,0), False])],

    "clav-1.R" : [("CopyRot", C_LOCAL, 1, ["clavicle.R", "clavicle.R", (1,1,1), (0,0,0), False])],
    "clav-2.R" : [("CopyRot", C_LOCAL, 1, ["clavicle.R", "clavicle.R", (1,1,1), (0,0,0), False])],
    "clav-3.R" : [("CopyRot", C_LOCAL, 1, ["clavicle.R", "clavicle.R", (1,1,1), (0,0,0), False])],
